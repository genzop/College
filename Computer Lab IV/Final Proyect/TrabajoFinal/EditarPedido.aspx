            ...
            <div class="formPedidos" style="width: 1000px; margin-left:auto; margin-right: auto">                       
                ...
                <asp:Table runat="server" style="width: 100%">
                    <asp:TableRow>
                        ...
                        </asp:TableCell></asp:TableRow></asp:Table><!-- Domicilio --><asp:Table runat="server" style="width: 100%">
                    <asp:TableRow>
                        ...
                        </asp:TableCell></asp:TableRow></asp:Table><!-- Detalles --><asp:Table runat="server" style="margin-left: auto; margin-right: auto">
                    <asp:TableRow>
                        <asp:TableCell>
                        ...
                        </asp:TableCell></asp:TableRow></asp:Table><div style="box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.2), 0 5px 5px 0 rgba(0, 0, 0, 0.24); width: 80%; margin-left: auto; margin-right: auto; margin-bottom: 20px">
                ...
                <div id="formularioDetalle" runat="server" class="formPedidos" style="margin: 0 auto; width: 80%; padding: 20px; margin-bottom: 50px" visible="false">
                    ...
                    <asp:Table runat="server">
                        <asp:TableRow>
                            ...
                            </asp:TableCell></asp:TableRow></asp:Table><table style="margin: 0 auto; border-spacing: 40px 0">
                        <tr>
                            <td>
                ...
                <asp:Table runat="server" Width="100%">
                    <asp:TableRow>
                        ...
                        </asp:TableCell></asp:TableRow></asp:Table><div class="editContent" style="text-align: right">
